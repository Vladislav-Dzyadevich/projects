...
class Parser:
    ...
    def factor(self):
        """Парсер для 'factor' правила граматики. У нашому випадку - це числа або вираз у дужках."""
    ...
    def term(self):
        """Парсер для 'term' правила граматики. У нашому випадку - це множення та ділення."""
        node = self.factor()
